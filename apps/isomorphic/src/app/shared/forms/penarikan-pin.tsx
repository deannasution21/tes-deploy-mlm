...
export default function PenarikanPinPage() {
  ...
  const doTransfer = async (payload: any) => {
    ...
    fetchWithAuth<any>(
      ...
      .catch((error) => {
        toast.error(<Text as="b">Penarikan PIN Gagal</Text>);
        console.error(error);
        setLoadingS(false);
      });
  };
  ...
  const onSubmit: SubmitHandler<PenarikanPinInput> = (data) => {
    setLoadingS(true);
    ...
    if (!tujuan) {
      ...
      Swal.fire({
        ...
        if (result.isConfirmed) {
          if (data.amount > 2000) {
            toast.error(
              <Text as="b">Max 2000 PIN dalam sekali penarikan</Text>
            );
          } else {
            doTransfer({
          ...
          toast.success(<Text as="b">Penarikan dibatalkan!</Text>);
          setLoadingS(false);
        }
      });
    }
  ...
  useEffect(() => {
    ...
    if (session?.user?.id !== 'adminpin2026') {
  ...
  return (
    <div className="@container">
      <div className="grid grid-cols-1 gap-6 3xl:gap-8">
        <WidgetCard
          title={<span className="text-[#c69731]">Form Penarikan PIN</span>}
          titleClassName="text-gray-700 font-bold text-2xl sm:text-2xl font-inter mb-5"
        >
          <div>
            <Form<PenarikanPinInput>
              validationSchema={penarikanPinSchema}
              onSubmit={onSubmit}
                    ...
                    <div className="flex-grow pb-10">
                      <Alert variant="flat" color="success" className="mb-7">
                        ...
                        <ol className="list-disc ps-5">
                          ...
                          <li>
                            <Text className="break-normal">
                              Pastikan Username/ID pengirim/tujuan dalam huruf
                              kecil semua
                            </Text>
                          </li>
                        </ol>
                      ...
                      <div className="grid grid-cols-1 gap-8 divide-y divide-dashed divide-gray-200 @2xl:gap-10 @3xl:gap-12">
                        <FormBlockWrapper title={'Data Pengirim:'}>
                          <Input
                            label="Username Member Pengirim"
